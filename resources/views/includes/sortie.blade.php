...
<section>
    <div class="w-full mx-auto mt-6 bg-gray-300 rounded-lg">
        ...
        <div class="grid grid-cols-1 gap-1 -mt-8 lg:grid-cols-4 sm:grid-cols-2">
			...
			<div class="h-[450px]">
                <a href="film/{{$film->id_film}}" class="relative flex items-end justify-start w-full overflow-hidden text-left bg-center bg-contain bg-no-repeat rounded-lg affiche1 h-[30rem] sm:h-[30rem] scale-75"
