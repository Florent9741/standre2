...
const stopVideos = () => {
  ...
  document.querySelectorAll('video').forEach(v => { v.pause() });
    ...
    <button @click="modelOpen =!modelOpen"
        class="flex items-center justify-center w-auto px-3 py-2 space-x-2 bg-red-700 hover:bg-red-500 rounded-lg shadow-md ">
    ...
    <div x-cloak x-show="modelOpen" class="fixed inset-0 z-50 overflow-y-auto mt-16" aria-labelledby="modal-title"
        role="dialog" aria-modal="true" onclick="stopVideos();">
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0 lg:mt-16 md:mt-8">
            ...
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                class="flex flex-col items-center h-[600px] justify-center w-3/4 p-8 m-auto space-x-4 overflow-hidden transition-all transform 2xl:max-h-2xl 2xl:max-w-2xl">
                    ...
                    <iframe height="100%" width="100%" src="{{ $filma->bandeannonce }}"
                        ...
                        class="flex items-center justify-center w-auto px-3 py-2 my-4 space-x-2 bg-red-700 hover:bg-red-500 rounded-lg shadow-md ">
